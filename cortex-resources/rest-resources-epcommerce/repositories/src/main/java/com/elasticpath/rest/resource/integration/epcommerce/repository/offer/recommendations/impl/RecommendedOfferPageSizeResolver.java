...
/**
 * Recommended offers page size resolver.
 */
@Singleton
@Named("recommendedOffersPageSizeResolver")
public class RecommendedOfferPageSizeResolver implements ManagedService {

	private static final Logger LOG = LoggerFactory.getLogger(RecommendedOfferPageSizeResolver.class);
	/**
