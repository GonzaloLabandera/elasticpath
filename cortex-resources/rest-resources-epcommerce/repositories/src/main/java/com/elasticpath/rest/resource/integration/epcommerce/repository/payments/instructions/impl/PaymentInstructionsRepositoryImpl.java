 ...
 */
@Component
public class PaymentInstructionsRepositoryImpl<E extends InstructionsEntity, I extends PaymentInstructionsIdentifier>
		implements Repository<InstructionsEntity, PaymentInstructionsIdentifier> {

	@Override
	public Single<InstructionsEntity> findOne(final PaymentInstructionsIdentifier identifier) {
