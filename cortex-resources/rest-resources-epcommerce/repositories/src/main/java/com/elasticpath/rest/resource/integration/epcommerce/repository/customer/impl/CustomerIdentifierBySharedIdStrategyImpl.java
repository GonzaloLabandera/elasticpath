...
/**
 * Implementation of CustomerIdentifierStrategy which uses shared id.
 */
@Component(property = "customerIdentificationKeyField=SHARED_ID")
public class CustomerIdentifierBySharedIdStrategyImpl implements CustomerIdentifierStrategy {
