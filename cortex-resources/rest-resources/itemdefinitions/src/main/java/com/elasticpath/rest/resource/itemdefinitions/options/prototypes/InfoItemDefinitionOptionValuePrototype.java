...
/**
 * Item Definition Option Value prototype for Info operation.
 */
public class InfoItemDefinitionOptionValuePrototype implements ItemDefinitionOptionValueResource.Info {
