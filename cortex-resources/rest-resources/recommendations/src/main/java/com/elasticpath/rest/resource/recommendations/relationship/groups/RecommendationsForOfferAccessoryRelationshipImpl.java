...
import com.elasticpath.rest.definition.recommendations.RecommendationsForOfferAccessoryRelationship;
 ...
 */
public class RecommendationsForOfferAccessoryRelationshipImpl implements RecommendationsForOfferAccessoryRelationship.LinkTo {
	 ...
	 */
	@Inject
	public RecommendationsForOfferAccessoryRelationshipImpl(@RequestIdentifier final OfferRecommendationGroupsIdentifier groupsIdentifier) {
	...
	public Observable<OfferRecommendationGroupIdentifier> onLinkTo() {
		return Observable.just(OfferRecommendationGroupIdentifier.builder()
				...
				.withRecommendationGroupId(StringIdentifier.of(ProductAssociationType.ACCESSORY.getName()))
				.build());
	}
}
