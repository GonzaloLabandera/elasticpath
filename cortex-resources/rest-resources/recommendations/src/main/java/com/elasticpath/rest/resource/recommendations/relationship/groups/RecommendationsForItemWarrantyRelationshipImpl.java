...
import com.elasticpath.rest.definition.recommendations.RecommendationsForItemWarrantyRelationship;
 ...
 */
public class RecommendationsForItemWarrantyRelationshipImpl implements RecommendationsForItemWarrantyRelationship.LinkTo {
	 ...
	 */
	@Inject
	public RecommendationsForItemWarrantyRelationshipImpl(@RequestIdentifier final ItemRecommendationGroupsIdentifier groupsIdentifier) {
	...
	public Observable<ItemRecommendationGroupIdentifier> onLinkTo() {
		return Observable.just(ItemRecommendationGroupIdentifier.builder()
				...
				.withGroupId(StringIdentifier.of(ProductAssociationType.WARRANTY.getName()))
				.build());
	}
}
