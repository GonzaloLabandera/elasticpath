...
import com.elasticpath.rest.definition.recommendations.RecommendationsForOfferReplacementRelationship;
 ...
 */
public class RecommendationsForOfferReplacementRelationshipImpl implements RecommendationsForOfferReplacementRelationship.LinkTo {
	 ...
	 */
	@Inject
	public RecommendationsForOfferReplacementRelationshipImpl(@RequestIdentifier final OfferRecommendationGroupsIdentifier groupsIdentifier) {
	...
	public Observable<OfferRecommendationGroupIdentifier> onLinkTo() {
		return Observable.just(OfferRecommendationGroupIdentifier.builder()
				...
				.withRecommendationGroupId(StringIdentifier.of(ProductAssociationType.REPLACEMENT.getName()))
				.build());
	}
}
