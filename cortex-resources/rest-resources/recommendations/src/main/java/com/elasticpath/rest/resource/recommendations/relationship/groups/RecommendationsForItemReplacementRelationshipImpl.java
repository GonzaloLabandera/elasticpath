...
import com.elasticpath.rest.definition.recommendations.RecommendationsForItemReplacementRelationship;
 ...
 */
public class RecommendationsForItemReplacementRelationshipImpl implements RecommendationsForItemReplacementRelationship.LinkTo {
	 ...
	 */
	@Inject
	public RecommendationsForItemReplacementRelationshipImpl(@RequestIdentifier final ItemRecommendationGroupsIdentifier groupsIdentifier) {
	...
	public Observable<ItemRecommendationGroupIdentifier> onLinkTo() {
		return Observable.just(ItemRecommendationGroupIdentifier.builder()
				...
				.withGroupId(StringIdentifier.of(ProductAssociationType.REPLACEMENT.getName()))
				.build());
	}
}
