...
import com.elasticpath.rest.definition.recommendations.RecommendationsForOfferRecommendationRelationship;
 ...
 */
public class RecommendationsForOfferRecommendationRelationshipImpl implements RecommendationsForOfferRecommendationRelationship.LinkTo {
	 ...
	 */
	@Inject
	public RecommendationsForOfferRecommendationRelationshipImpl(@RequestIdentifier final OfferRecommendationGroupsIdentifier groupsIdentifier) {
	...
	public Observable<OfferRecommendationGroupIdentifier> onLinkTo() {
		return Observable.just(OfferRecommendationGroupIdentifier.builder()
				...
				.withRecommendationGroupId(StringIdentifier.of(ProductAssociationType.RECOMMENDATION.getName()))
				.build());
	}
}
