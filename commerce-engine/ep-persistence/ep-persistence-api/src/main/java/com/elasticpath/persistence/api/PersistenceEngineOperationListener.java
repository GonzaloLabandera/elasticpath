...
public interface PersistenceEngineOperationListener {
	 ...
	 */
	default void beginSingleOperation(Persistable object, ChangeType type) {
		//do nothing
	}
	 ...
	 * @param type The type of change.
	 */
	default void beginBulkOperation(String queryName, String queryString, String parameters, ChangeType type) {
		//do nothing
	}
	 ...
	 * @param type The type of change.
	 */
	default void endSingleOperation(Persistable object, ChangeType type) {
		//do nothing
	}
