...
(
        ...
        `LAST_VALUE` BIGINT(8) NULL)Engine=InnoDB;
...
(
        UIDPK BIGINT(8) NOT NULL,
        TAX_REGION_UID BIGINT(8),
        TAX_CODE_UID BIGINT(8),
        VALUE DECIMAL(19,4),
    PRIMARY KEY(UIDPK),
...
(
        ...
        MAX_OVERRIDE_VALUES BIGINT(8) default 0,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        SETTING_DEFINITION_UID BIGINT(8),
...
(
        ...
        PREF_BILL_ADDRESS_UID BIGINT(8),
        PREF_SHIP_ADDRESS_UID BIGINT(8),
        CREATION_DATE DATETIME NOT NULL,
        LAST_EDIT_DATE TIMESTAMP default CURRENT_TIMESTAMP NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        STATUS INT NOT NULL,
        AUTHENTICATION_UID BIGINT(8),
        STORE_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        ATTRIBUTE_UID BIGINT(8) NOT NULL,
        ATTRIBUTE_TYPE INT NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        CUSTOMER_UID BIGINT(8) NOT NULL,
...
(
        ...
        CATEGORY_TYPE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        CATEGORY_UID BIGINT(8) NOT NULL,
        DELETED_DATE DATETIME NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        CM_USER_UID BIGINT(8) NOT NULL,
        USER_ROLE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        CUSTOMER_GROUP_UID BIGINT(8) NOT NULL,
...
(
        CUSTOMER_UID BIGINT(8) NOT NULL,
        CUSTOMERGROUP_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        IMPORT_JOB_UID BIGINT(8) NOT NULL,
...
(
        ...
        IP_ADDRESS VARCHAR(255),
        ORDER_BILLING_ADDRESS_UID BIGINT(8),
        TOTAL DECIMAL(19,2),
        STATUS VARCHAR(20),
...
(
        UIDPK BIGINT(8) default 1 NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        ORDER_UID BIGINT(8) NOT NULL,
        USER_UID BIGINT(8) NOT NULL,
        CREATED_DATE BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        SHIPPING_REGION_UID BIGINT(8) NOT NULL,
        STORE_UID BIGINT(8) NOT NULL,
        SCCM_UID BIGINT(8) NOT NULL,
        CARRIER VARCHAR(255),
        CODE VARCHAR(64) NOT NULL,
...
(
        ...
        INCLUSIVE_TAX INT,
        ORDER_ADDRESS_UID BIGINT(8),
        ORDER_UID BIGINT(8),
        SERVICE_LEVEL_UID BIGINT(8),
        PICKLIST_UID BIGINT(8),
...
(
        ...
        STATUS VARCHAR(20),
        ORDER_UID BIGINT(8),
        GIFTCERTIFICATE_UID BIGINT(8),
        ORDERSHIPMENT_UID BIGINT(8),
...
(
        ...
        EXCHANGE_ORDER_UID BIGINT(8),
        ORDER_PAYMENT_UID BIGINT(8),
        LESS_RESTOCK_AMOUNT DECIMAL(19,2),
        SHIPPING_COST DECIMAL(19,2) default 0 NOT NULL,
        LAST_MODIFIED_DATE TIMESTAMP default CURRENT_TIMESTAMP NOT NULL,
        RECEIVED_BY BIGINT(8),
        VERSION INT,
        ORDER_RETURN_ADDRESS_UID BIGINT(8),
    PRIMARY KEY(UIDPK),
...
(
        ...
        VALUE DECIMAL(19,2),
        ORDER_SHIPMENT_UID BIGINT(8),
        ORDER_RETURN_UID BIGINT(8),
    PRIMARY KEY(UIDPK),
...
(
        ...
        TEMPLATE VARCHAR(255) NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        TAX_CODE_UID BIGINT(8) NOT NULL,
        CATALOG_UID BIGINT(8) NOT NULL,
...
(
        ...
        END_DATE DATETIME,
        IMAGE VARCHAR(255),
        PRODUCT_TYPE_UID BIGINT(8) NOT NULL,
        BRAND_UID BIGINT(8),
        DEFAULT_SKU_UID BIGINT(8),
        CODE VARCHAR(64) NOT NULL,
...
(
        ...
        WAREHOUSE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        PARENT_ITEM_UID BIGINT(8),
        LAST_MODIFIED_DATE TIMESTAMP default CURRENT_TIMESTAMP NOT NULL,
        CREATED_DATE DATETIME NOT NULL,
        SKUCODE VARCHAR(255) NOT NULL,
        TAXCODE VARCHAR(255) NOT NULL,
        PRODUCT_SKU_UID BIGINT(8),
        ORDER_SHIPMENT_UID BIGINT(8),
        QUANTITY INT,
...
(
        ...
        SOURCE_PRODUCT_UID BIGINT(8) NOT NULL,
        TARGET_PRODUCT_UID BIGINT(8) NOT NULL,
        CATALOG_UID BIGINT(8),
        START_DATE DATETIME NOT NULL,
        END_DATE DATETIME,
...
(
        ...
        NAME VARCHAR(255) NOT NULL,
        DESCRIPTION VARCHAR(255),
        RULE_SET_UID BIGINT(8),
        STORE_UID BIGINT(8),
        CATALOG_UID BIGINT(8),
        CM_USER_UID BIGINT(8),
        ENABLED INTEGER NOT NULL,
        CURRENT_LUP_NUMBER BIGINT(8),
        SELLING_CTX_UID BIGINT(8),
    PRIMARY KEY(UIDPK),
...
(
        ...
        CARTITEM_UID BIGINT(8),
        ORDERSKU_UID BIGINT(8),
        LIST_UNIT_PRICE DECIMAL(19,2),
        SALE_UNIT_PRICE DECIMAL(19,2),
        PROMO_UNIT_PRICE DECIMAL(19,2),
    PRIMARY KEY(UIDPK),
...
(
        ...
        ORDERING INT,
        SKU_OPTION_UID BIGINT(8) NOT NULL,
        IMAGE VARCHAR(255),
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        PRODUCT_SKU_UID BIGINT(8) NOT NULL,
        OPTION_KEY VARCHAR(100) NOT NULL,
        OPTION_VALUE_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        ORDERSKU_UID BIGINT(8) NOT NULL,
        DIGITALASSET_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        APPLIED_RULE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        TOP_SELLER_UID BIGINT(8) NOT NULL,
        PRODUCT_UID BIGINT(8) NOT NULL,
...
(
        ...
        CATEGORY_RESTRICTION BIGINT(8) default 0 NOT NULL,
    PRIMARY KEY(UIDPK))Engine=InnoDB;
...
(
        STORE_UID BIGINT(8) NOT NULL,
        TAXJURISDICTION_UID BIGINT(8) NOT NULL,
...
(
        ...
        PAYMENTGATEWAY_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        STORE_UID BIGINT(8) NOT NULL,
        ASSOCIATED_STORE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        OBJECT_GROUP_MEMBER_UID BIGINT(8) NOT NULL,
        METADATA_KEY VARCHAR(255) NOT NULL,
...
(
        ...
        CHANGESET_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        SELLING_CONTEXT_UID BIGINT(8) NOT NULL,
...
(
        ...
        DESCRIPTION VARCHAR(255),
        PRIORITY INT NOT NULL,
        CSDC_CONTENT_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        CSDYNAMICCONTENT_UID BIGINT(8) NOT NULL,
...
(
        ...
        CSPARAMETERVALUE_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        DC_DELIVERY_UID BIGINT(8) NOT NULL,
        DC_CONTENTSPACE_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        CHANGE_TRANSACTION_UID BIGINT(8) NOT NULL,
        METADATA_KEY VARCHAR(255) NOT NULL,
        METADATA_VALUE VARCHAR(255) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        ...
        CHANGE_OPERATION_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        GUID VARCHAR(64) NOT NULL,
        BUNDLE_UID BIGINT(8) NOT NULL,
        CONSTITUENT_UID BIGINT(8),
        CONSTITUENT_SKU_UID BIGINT(8),
...
(
        ...
        CARTITEM_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        ...
        CATALOG_UID BIGINT(8) NOT NULL,
        PRLISTDSCR_UID BIGINT(8) NOT NULL,
        SELLING_CTX_UID BIGINT(8),
        HIDDEN INTEGER default 0,
    PRIMARY KEY(UIDPK),
...
(
        ...
        IMPORT_NOTIFICATION_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        UIDPK BIGINT(8) NOT NULL,
        IMPORT_JOB_STATUS_UID BIGINT(8) NOT NULL,
...
(
        UIDPK BIGINT(8) NOT NULL,
        IMPORT_BAD_ROW_UID BIGINT(8) NOT NULL,
        LEVEL_NUMBER INT,
        CODE VARCHAR(255),
...
(
        UIDPK BIGINT(8) NOT NULL,
        COUPONCODE VARCHAR(255) NOT NULL,
        COUPON_CONFIG_UID BIGINT(8) NOT NULL,
...
(
        WISHLIST_UID BIGINT(8) NOT NULL,
        ITEM_UID BIGINT(8) NOT NULL,
...
(
        SHOPPING_CART_UID BIGINT(8) NOT NULL,
        ITEM_UID BIGINT(8) NOT NULL,
...
(
        ...
        NAME VARCHAR(255) NOT NULL,
        GUID VARCHAR(100) NOT NULL,
        CAMPAIGN_UID BIGINT(8) NOT NULL,
    PRIMARY KEY(UIDPK),
...
(
        ...
        NAME VARCHAR(255),
        STORE_UID BIGINT(8),
        OFFER_VALUE_ENTITY_UID BIGINT(8),
...
(
        UIDPK BIGINT(8) NOT NULL,
        EXPERIENCE_UID BIGINT(8) NOT NULL,
        OFFER_UID BIGINT(8) NOT NULL,
