 ...
 *
 * @deprecated use {@link EventMessageTriggeredEmailRouteBuilder}.
 */
@Deprecated
public class LegacyEventMessageTriggeredEmailRouteBuilder extends RouteBuilder {
	...
	private LegacyEmailProducer emailProducer;
	...
	public void setEmailProducer(final LegacyEmailProducer emailProducer) {
		this.emailProducer = emailProducer;
	}

	protected LegacyEmailProducer getEmailProducer() {
