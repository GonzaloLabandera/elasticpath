 ...
 */
public class EventMessageObjectMapperImpl extends ObjectMapper implements EventMessageObjectMapper {
	...
	public <T extends EventType> void unregisterEventType(final EventTypeProvider<T> eventTypeProvider) {
		//	One strategy could be to keep a shadow copy of all EventTypeProviders in EventMessageObjectMapperImpl,
