 ...
 */
public class SqlActionException extends DataPopulationActionException {
	 ...
	 */
	public SqlActionException(final String message) {
		super(message);
	}
	 ...
	 */
	public SqlActionException(final Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the nested cause of the exception.
	 */
	public SqlActionException(final String message, final Throwable cause) {
		super(message, cause);
	}
}