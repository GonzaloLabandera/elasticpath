 ...
 */
public class FilterDirectoryActionException extends DataPopulationActionException {
	 ...
	 * Default constructor.
	 */
	public FilterDirectoryActionException() {
		super();
	}
	 ...
	 */
	public FilterDirectoryActionException(final String message) {
		super(message);
	}
	 ...
	 */
	public FilterDirectoryActionException(final Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the nested cause of the exception.
	 */
	public FilterDirectoryActionException(final String message, final Throwable cause) {
		super(message, cause);
	}
}