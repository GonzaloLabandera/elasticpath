 ...
 */
public class FilterDataActionException extends DataPopulationActionException {
	 ...
	 * Default constructor.
	 */
	public FilterDataActionException() {
		super();
	}
	 ...
	 */
	public FilterDataActionException(final String message) {
		super(message);
	}
	 ...
	 */
	public FilterDataActionException(final Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the nested cause of the exception.
	 */
	public FilterDataActionException(final String message, final Throwable cause) {
		super(message, cause);
	}
}