...
public class ModifierGroupDaoAdapterImplTest {
	...
	public void setUp() {
		...
		target.setEntityLocator(mockEntityLocator);

		given(mockEntityLocator.locatePersistence(CART_ITEM_MODIFIER_GROUP_GUID, ModifierGroup.class)).willReturn(mockModifierGroup);
		given(mockEntityLocator.locatePersistence(NON_EXIST_CART_ITEM_MODIFIER_GROUP_GUID, ModifierGroup.class)).willReturn(null);
