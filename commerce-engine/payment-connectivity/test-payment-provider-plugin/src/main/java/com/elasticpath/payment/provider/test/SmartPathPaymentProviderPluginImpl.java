...
/**
 * Smart path payment provider plugin, supporting all capabilities.
 */
@Component("smartPathPaymentProviderPlugin")
@Scope("prototype")
public class SmartPathPaymentProviderPluginImpl extends AbstractSmartPathPaymentProviderPlugin implements
		PICClientInteractionRequestCapability,
		ReserveCapability, ModifyCapability,
		CreditCapability, CancelCapability, ChargeCapability, ReverseChargeCapability {
