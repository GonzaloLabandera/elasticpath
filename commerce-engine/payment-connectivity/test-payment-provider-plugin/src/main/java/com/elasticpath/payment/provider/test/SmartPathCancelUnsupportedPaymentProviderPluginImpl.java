 ...
 */
@Component("smartPathCancelUnsupportedPaymentProviderPlugin")
@Scope("prototype")
public class SmartPathCancelUnsupportedPaymentProviderPluginImpl extends AbstractSmartPathPaymentProviderPlugin implements
	...
	public String getPaymentVendorId() {
		return "Smart Path Cancel Unsupported";
	}
