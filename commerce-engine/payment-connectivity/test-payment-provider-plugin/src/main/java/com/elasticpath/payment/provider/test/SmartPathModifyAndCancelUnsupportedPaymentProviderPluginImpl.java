...
/**
 * Smart path payment provider plugin, that does not support modify and cancel capabilities.
 */
@Component("smartPathModifyAndCancelUnsupportedPaymentProviderPlugin")
@Scope("prototype")
public class SmartPathModifyAndCancelUnsupportedPaymentProviderPluginImpl extends AbstractSmartPathPaymentProviderPlugin implements
		PICClientInteractionRequestCapability,
		ReserveCapability, CreditCapability, ChargeCapability, ReverseChargeCapability {

	@Override
	public String getPaymentVendorId() {
		return "Smart Path Modify And Cancel Unsupported";
	}
