 ...
 */
@Component("smartPathReserveUnsupportedPaymentProviderPlugin")
@Scope("prototype")
public class SmartPathReserveUnsupportedPaymentProviderPluginImpl extends AbstractSmartPathPaymentProviderPlugin implements
		PICClientInteractionRequestCapability,
		ModifyCapability, CancelCapability, // these don't make sense without reserve, but we'll support them anyway for better test coverage
		CreditCapability, ChargeCapability, ReverseChargeCapability {

	@Override
	public String getPaymentVendorId() {
		return "Smart Path Reserve Unsupported";
	}
