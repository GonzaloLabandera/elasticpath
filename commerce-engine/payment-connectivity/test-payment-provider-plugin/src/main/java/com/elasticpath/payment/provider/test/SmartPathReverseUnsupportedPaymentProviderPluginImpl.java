 ...
 */
@Component("smartPathReverseUnsupportedPaymentProviderPlugin")
@Scope("prototype")
public class SmartPathReverseUnsupportedPaymentProviderPluginImpl extends AbstractSmartPathPaymentProviderPlugin implements
		PICClientInteractionRequestCapability,
		ReserveCapability, ModifyCapability, CancelCapability,
		ChargeCapability, CreditCapability {

	@Override
	public String getPaymentVendorId() {
		return "Smart Path Reverse Unsupported";
	}
