...
/**
 * Cancel capability request builder.
 */
public final class CancelCapabilityRequestBuilder {
	...
	private CancelCapabilityRequestBuilder() {
	}

	/**
	 * Creates cancel capability request builder.
	 *
	 * @return the builder
	 */
	public static CancelCapabilityRequestBuilder builder() {
		return new CancelCapabilityRequestBuilder();
	}
	 ...
	 * @return the builder
	 */
	public CancelCapabilityRequestBuilder withAmount(final MoneyDTO amount) {
		this.amount = amount;
		return this;
	}
	 ...
	 * @return the builder
	 */
	public CancelCapabilityRequestBuilder withPaymentInstrumentData(final Map<String, String> paymentInstrumentData) {
	 ...
	 * @return the builder
	 */
	public CancelCapabilityRequestBuilder withCustomRequestData(final Map<String, String> customRequestData) {
	 ...
	 * @return the builder
	 */
	public CancelCapabilityRequestBuilder withOrderContext(final OrderContext orderContext) {
	 ...
	 * @return the builder
	 */
	public CancelCapabilityRequestBuilder withReservationData(final Map<String, String> reservationData) {
	 ...
	 */
	public CancelCapabilityRequest build(final CancelCapabilityRequest request) {
		if (amount == null) {
