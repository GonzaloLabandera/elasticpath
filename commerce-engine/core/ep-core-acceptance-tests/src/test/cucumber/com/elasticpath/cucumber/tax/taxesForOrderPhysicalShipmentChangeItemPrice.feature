@tax
Feature: taxesForOrderPhysicalShipmentChangeItemPricess
...
Scenario: Tax Calculation for Changing Item Prices of Order Physical Shipment 
...
When tax rates are changed to
	...
	And the order physical shipment is modified by changing these items prices
		| price  | skuCode   |
		| 100.00 | ETX-105PE |	
