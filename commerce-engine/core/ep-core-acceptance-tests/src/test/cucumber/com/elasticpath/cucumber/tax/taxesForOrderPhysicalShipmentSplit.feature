@tax
Feature: taxesForOrderPhysicalShipmentSplit
...
Scenario: Tax Calculation for Removing items to a New Order Physical Shipment
...
When tax rates are changed to
	...
	And the order physical shipment is modified by moving these items into a new shipment
		| quantity | skuCode |
		| 1		   | GPS-201 |	
...
Then I expect that the tax journal should have purchase entries and reversal entries at the corresponding tax rates 
		...
		| purchase	  | Order 			| GPS-201 	| 200.00	 | PST	   | GOODS	  | 14.00	  | 0.07 	| CA			  | BC		  |
		| purchase	  | Order 			| GPS-201 	| 200.00	 | GST	   | GOODS	  | 10.00	  | 0.05    | CA			  | CA		  |			
		...
		| reversal	  | Order Change	| GPS-201 	| -200.00	 | PST	   | GOODS	  | -14.00	  | 0.07 	| CA			  | BC		  |
		| reversal	  | Order Change	| GPS-201 	| -200.00	 | GST	   | GOODS	  | -10.00	  | 0.05    | CA			  | CA		  |			
		...
		| purchase	  | Order Change	| GPS-201 	| 100.00	 | PST	   | GOODS	  | 10.00	  | 0.10 	| CA			  | BC		  |
		| purchase	  | Order Change	| GPS-201 	| 100.00	 | GST	   | GOODS	  | 10.00	  | 0.10    | CA			  | CA		  |		
