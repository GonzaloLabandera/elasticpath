@tax
Feature: taxesForOrderPhysicalShipmentAddItems
...
Scenario: Tax Calculation for Adding items to Order Physical Shipment
...
When tax rates are changed to
	...
	And the order physical shipment is modified by adding these items
		| quantity | skuCode |
		| 1		   | GPS-201 |	
