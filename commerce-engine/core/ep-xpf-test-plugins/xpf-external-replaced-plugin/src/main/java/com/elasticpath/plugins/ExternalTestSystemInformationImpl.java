 ...
 */
public class ExternalTestSystemInformationImpl extends XPFExternalPlugin {
	 ...
	 */
	public ExternalTestSystemInformationImpl(final PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class TestSystemInformation extends XPFExtensionPointImpl implements SystemInformation {
		...
		public String getSimpleValue() {
			return "External replaced test plugin!";
		}
	}
}
