...
public interface FilteredPaymentInstrumentService {
	 ...
	 * @return default payment instrument for defined customer and store
	 */
	CustomerPaymentInstrument findDefaultPaymentInstrumentForCustomerGuidAndStore(String customerGuid, String storeCode);
	...
	/**
	 * Finds collection of CartOrderPaymentInstrument for defined cartOrder guid and store.
	 *
	 * @param cartOrderGuid cart order guid
	 * @param storeCode store code
	 * @return collection of CartOrderPaymentInstrument for defined cartOrder and store
	 */
	Collection<CartOrderPaymentInstrument> findCartOrderPaymentInstrumentsForCartOrderGuidAndStore(String cartOrderGuid, String storeCode);
}
