...
import com.elasticpath.validation.validators.impl.DecimalValidator;

/**
 * A constraint for decimal values.
 */
@Documented
...
public @interface DecimalConstraint {
	 ...
	 *
	 * @return String message, default {field.invalid.decimal.format}
	 */
	String message() default "{field.invalid.decimal.format}";
