...
public class CatalogCurrencyPercentDiscountActionImpl extends AbstractRuleActionImpl {
	...
	public String getRuleCode() {
		validate();
		return "\t\tdelegate.applyCatalogCurrencyDiscountPercent("
				+ this.getRuleId() + "L, "
				+ this.getUidPk() + "L, "
				+ "prices.get(product.getCode()), "
				+ "currency.getCurrencyCode(), \"" + this.getParamValue(RuleParameter.CURRENCY_KEY) + "\", \""
				+ this.getParamValue(RuleParameter.DISCOUNT_PERCENT_KEY)
				+ "\");\n";
	}
