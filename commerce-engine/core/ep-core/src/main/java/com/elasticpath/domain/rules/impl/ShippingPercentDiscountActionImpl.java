...
public class ShippingPercentDiscountActionImpl extends AbstractRuleActionImpl {
	/**
	 * Serial version id.
	 */
	...
	public String getRuleCode() throws EpDomainException {
		...
		code.append("\t\tdelegate.applyShippingDiscountPercent(cart, discountItemContainer, ");
