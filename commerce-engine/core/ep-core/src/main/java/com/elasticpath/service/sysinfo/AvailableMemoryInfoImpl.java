...
/**
 * System metric extension for returning available memory.
 */
@SuppressWarnings("checkstyle:magicnumber")
@Extension
@XPFEmbedded
@XPFAssignment(extensionPoint = XPFExtensionPointEnum.SYSTEM_INFORMATION, priority = 1100)
public class AvailableMemoryInfoImpl extends XPFExtensionPointImpl implements SystemInformation {
	...
	public String getSimpleValue() {
		return String.valueOf(Runtime.getRuntime().freeMemory() / BYTES_PER_KILOBYTE / KILOBYTES_PER_MEGABYTE);
	}
}
