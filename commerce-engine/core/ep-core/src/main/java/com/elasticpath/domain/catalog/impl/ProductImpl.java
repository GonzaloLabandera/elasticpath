...
@FetchGroups({
	...
	@FetchAttribute(name = "localeDependantFieldsMap"), @FetchAttribute(name = "brand"), @FetchAttribute(name = "attributeValueMap"),
	@FetchAttribute(name = "productType"), @FetchAttribute(name = "availabilityCriteriaInternal"),
