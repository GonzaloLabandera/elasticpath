...
public interface ShippingServiceLevelService extends EpPersistenceService {
	 ...
	 */
	List<ShippingServiceLevel> retrieveShippingServiceLevel(ShoppingCart shoppingCart);
	 ...
	 */
	boolean isShippingServiceLevelInUse(Long shippingServiceLevelUidpk);
	 ...
	 */
	List<ShippingServiceLevel> findByCriteria(ShippingLevelsSearchCriteriaImpl searchCriteria);
	 ...
	 */
	List<ShippingServiceLevel> retrieveShippingServiceLevel(String storeCode, Address address);
