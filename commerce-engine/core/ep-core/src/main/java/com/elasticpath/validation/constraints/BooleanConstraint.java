...
import com.elasticpath.validation.validators.impl.BooleanValidator;
...
public @interface BooleanConstraint {
	 ...
	 *
	 * @return String message, default {field.invalid.boolean.format}
	 */
	String message() default "{field.invalid.boolean.format}";
