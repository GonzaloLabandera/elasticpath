...
public class CartProductPercentDiscountImplTest {
	...
	public void testApplyOnSingleItem() {
		...
		final int maxItems = 0;
		final BigDecimal discountPercent = new BigDecimal("0.25").setScale(CartProductPercentDiscountImpl.CALCULATION_SCALE);
	...
	public void testApplyOnTwoItems() {
		...
		final BigDecimal discountPercent = new BigDecimal("0.35").setScale(CartProductPercentDiscountImpl.CALCULATION_SCALE);
	...
	public void testDiscountRounding() {
		...
		final BigDecimal expectedDiscount = new BigDecimal("575").setScale(CartProductPercentDiscountImpl.CALCULATION_SCALE);
		...
		final CartProductPercentDiscountImpl discount =
				createCartProductPercentDiscountImpl("", RULE_ID, ACTION_ID, CART_ITEM_PRODUCT_CODE,
						discountPercent, maxItems, EXCEPTION_STR);
