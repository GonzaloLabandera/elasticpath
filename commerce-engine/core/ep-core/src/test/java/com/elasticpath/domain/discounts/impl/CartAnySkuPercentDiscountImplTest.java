...
public class CartAnySkuPercentDiscountImplTest {
	...
	public void testApplyOnSingleItem() {
		...
		final int maxItems = 0;
		final BigDecimal discountPercent = new BigDecimal("0.25").setScale(CartAnySkuPercentDiscountImpl.CALCULATION_SCALE);
		...
		context.checking(new Expectations() {
			{
				oneOf(totallingApplier).getTotalDiscount();	will(returnValue(totalDiscountAmount));
	...
	public void testApplyOnTwoItems() {
		...
		final BigDecimal discountPercent = new BigDecimal("0.50").setScale(CartAnySkuPercentDiscountImpl.CALCULATION_SCALE);
	...
	public void testDiscountRounding() {
		...
		final BigDecimal expectedDiscount = new BigDecimal("575").setScale(CartAnySkuPercentDiscountImpl.CALCULATION_SCALE);
		...
		Discount discount = createCartAnySkuPercentDiscountImpl("", RULE_ID, ACTION_ID, discountPercent, MAX_ITEMS, EXCEPTION_STR);
