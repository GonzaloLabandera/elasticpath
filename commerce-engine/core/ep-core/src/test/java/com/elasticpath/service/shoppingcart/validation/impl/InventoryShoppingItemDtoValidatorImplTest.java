...
public class InventoryShoppingItemDtoValidatorImplTest {
	...
	@InjectMocks
	private InventoryShoppingItemDtoValidatorImpl validator;
	...
	public void setUp() throws Exception {
		context = new ShoppingItemDtoValidationContextImpl();
		...
		given(shoppingItemDto.getQuantity()).willReturn(REQUESTED_QUANTITY);
