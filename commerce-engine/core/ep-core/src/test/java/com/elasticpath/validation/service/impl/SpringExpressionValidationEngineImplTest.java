 ...
 */
public class SpringExpressionValidationEngineImplTest {
	...
	private SpringExpressionValidationEngineImpl validationEngine;
	...
	public void setUp() {
		...
		validationEngine = new SpringExpressionValidationEngineImpl();
	}
	...
	public void testValidateConstraintWithTypeCheck() {
		...
		context.checking(new Expectations() { {
			...
			will(returnValue("(tagValue instanceof T(java.lang.Integer)) == true AND tagValue <= 10"));
		} });
