...
public class CartSkuPercentDiscountImplTest {
	...
	public void testApplyOnSingleItem() {
		...
		final int maxItems = 0;
		final BigDecimal discountPercent = new BigDecimal("0.25").setScale(CartSkuPercentDiscountImpl.CALCULATION_SCALE);
	...
	public void testApplyOnTwoItems() {
		...
		final BigDecimal discountPercent = new BigDecimal("0.35").setScale(CartSkuPercentDiscountImpl.CALCULATION_SCALE);
	...
	public void testDiscountRounding() {
		...
		final BigDecimal expectedDiscount = new BigDecimal("575").setScale(CartSkuPercentDiscountImpl.CALCULATION_SCALE);
		...
		final CartSkuPercentDiscountImpl discount =
				createCartSkuPercentDiscountImpl("", RULE_ID, ACTION_ID, CART_ITEM_PRODUCT_CODE,
