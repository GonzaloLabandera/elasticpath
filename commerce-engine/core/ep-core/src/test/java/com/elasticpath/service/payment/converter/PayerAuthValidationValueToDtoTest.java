...
public class PayerAuthValidationValueToDtoTest {
	...
	private final PayerAuthValidationValueToDto payerAuthValidationValueToDto = new PayerAuthValidationValueToDto();

	@Before
	public void setUp() throws Exception {
		beanFactory = context.mock(BeanFactory.class);
		expectationsFactory = new BeanFactoryExpectationsFactory(context, beanFactory);
		expectationsFactory.allowingBeanFactoryGetBean(ContextIdNames.PAYER_AUTH_VALIDATION_VALUE_DTO, PayerAuthValidationValueDtoImpl.class);
		payerAuthValidationValueToDto.setBeanFactory(beanFactory);
	}

	@Test
	public void testConvert() throws Exception {
		PayerAuthValidationValue source = new PayerAuthValidationValueImpl();
		...
		PayerAuthValidationValueDto target = payerAuthValidationValueToDto.convert(source);
