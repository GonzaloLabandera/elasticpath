...
/**
 * Test class for {@link AttributeRequiredValidatorForCustomer}.
 */
public class AttributeRequiredValidatorForCustomerTest {
	...
	private AttributeRequiredValidatorForCustomer validator;
	...
	@Before
	public void setUp() {
		validator = new AttributeRequiredValidatorForCustomer();
		...
		context.checking(new Expectations() {
			{
				allowing(customer).getCustomerProfile();
				will(returnValue(customerProfile));
				allowing(customer).getCustomerType();
				will(returnValue(CustomerType.REGISTERED_USER));
	...
	private void shouldGetAllCustomerProfileAttributes(final Attribute... attributes) {
		context.checking(new Expectations() {
			{
				oneOf(customerProfile).getProfileAttributes(CustomerType.REGISTERED_USER);
	...
	public void testRequiredAttributeNotOnProfile() {
		...
		assertFalse("Missing required attribute should fail", validator.isValid(customer, validatorContext));
	}
	...
	public void testRequiredAttributeBlankOnProfile() {
		...
		assertFalse("A blank value for required attribute should fail", validator.isValid(customer, validatorContext));
	}
	...
	public void testRequiredAttributeOnProfile() {
		...
		assertTrue("A valid value for required attribute should pass", validator.isValid(customer, validatorContext));
	}
	...
	public void test2RequiredAttributesBlank() {
		...
		assertFalse("Missing both required attributes should fail", validator.isValid(customer, validatorContext));
	}
	...
	public void test2RequiredAttributesValid() {
		...
		assertTrue("Setting correct values for both attributes should pass", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeDate() {
		...
		assertTrue("Valid date should pass", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeDateNull() {
		...
		assertFalse("null date should fail", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeInteger() {
		...
		assertTrue("valid integer should pass", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeIntegerNull() {
		...
		assertFalse("null integer should fail", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeBoolean() {
		...
		assertTrue("valid boolean should pass", validator.isValid(customer, validatorContext));
	}
	...
	public void testAttributeBooleanNull() {
		...
		assertFalse("null boolean should fail", validator.isValid(customer, validatorContext));
	}
	...
	private Attribute createAttributeWithType(final String attributeKey, final boolean required, final AttributeType attributeType) {
		...
		context.checking(new Expectations() {
			{
				allowing(attribute).getAttributeUsage();
				will(returnValue(AttributeUsageImpl.USER_PROFILE_USAGE));
