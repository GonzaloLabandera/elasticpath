...
/**
 * The implementation of the <code>Dto</code> interface that contains data of ModifierFieldOptionDTO object.
 */
@XmlAccessorType(XmlAccessType.NONE)
public class ModifierFieldOptionDTO implements Dto {
