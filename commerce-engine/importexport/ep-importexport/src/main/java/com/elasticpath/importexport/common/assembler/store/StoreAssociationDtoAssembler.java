 ...
 */
package com.elasticpath.importexport.common.assembler.store;
...
/**
 * Assembler for {@link Store} domain object and {@link com.elasticpath.common.dto.store.StoreDTO}.
 */
public class StoreAssociationDtoAssembler extends AbstractDtoAssembler<StoreAssociationDTO, Store> {
	...
	/**
	 * Returns the {@link Store} associated with the given code.
	 * @param storeCode code for the {@link Store}
	 * @return the requested {@link Store}
	 * @throws EpServiceException if the {@link Store} is not found.
	 */
