...
public class ModifierFieldDTO implements Dto {
	 ...
	 */
	public List<ModifierFieldOptionDTO> getModifierFieldOptions() {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("cartItemModifierFieldOptions", getModifierFieldOptions())
				.toString();
	}
}
