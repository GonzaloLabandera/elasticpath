...
/**
 * The cancellation of reservation request for Payment API.
 */
public class CancelReservationRequest implements PaymentAPIRequest {
	...
	/**
	 * Gets paymentEvents to cancel.
	 *
	 * @return the paymentEvents
	 */
	public List<PaymentEvent> getSelectedPaymentEventsToCancel() {
		return selectedPaymentEventsToCancel;
	}

	/**
	 * Sets paymentEvents to cancel.
	 *
	 * @param selectedPaymentEventsToCancel the orderPaymentInstruments
	 */
	public void setSelectedPaymentEventsToCancel(final List<PaymentEvent> selectedPaymentEventsToCancel) {
