@permissions
Feature: Buyer role for registered user
  ...
  Scenario Outline: Registered user gets default role BUYER from store and has access to cart.
  ...
  Scenario: Registered user gets default role BUYER from store and has access to prices.
  ...
  Scenario Outline: Registered user gets default role BUYER from store and has access to discount.
  ...
  Scenario Outline: Registered user gets default role BUYER from store and has access to total.
  ...
  Scenario Outline: Registered user gets default role BUYER from store and can create and update custom cart.
