...
Feature: Can retrieve promotions pricing on cart line ltem
  ...
  Scenario: Item with no sale price and tiered pricing
    ...
    And I can follow the price link
    Then the list-price has fields amount: 9.00, currency: CAD and display: $9.00
    And the purchase-price has fields amount: 9.00, currency: CAD and display: $9.00
  ...
  Scenario: Item with sale price and tiered pricing
    ...
    And I can follow the price link
    Then the list-price has fields amount: 9.00, currency: CAD and display: $9.00
    And the purchase-price has fields amount: 7.00, currency: CAD and display: $7.00
  ...
  Scenario: Item with no sale price and catalog promotion and cart lineitem promotion
    ...
    And I can follow the price link
    Then the list-price has fields amount: 10.00, currency: CAD and display: $10.00
    And the purchase-price has fields amount: 8.10, currency: CAD and display: $8.10
  ...
  Scenario: Item with sale price and tiered pricing and cart lineitem promotion
    ...
    And I can follow the price link
    Then the list-price has fields amount: 9.00, currency: CAD and display: $9.00
    And the purchase-price has fields amount: 6.30, currency: CAD and display: $6.30
