 ...
 */
public class ImportExportApiInteractionSteps {
	private final ImportExportApiClient client;

	/**
	 * Constructor.
	 */
	public ImportExportApiInteractionSteps() {
		client = new ImportExportApiClient(System.getProperty("ep.integration.baseurl"));
	}
