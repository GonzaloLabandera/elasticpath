 ...
 */
public class AddCustomerAddressDialog extends AbstractDialog {
	private static final String CUSTOMER_ADDRESS_PARENT_CSS = "div[automation-id='com.elasticpath.cmclient.fulfillment.FulfillmentMessages"
			+ ".AddressDialog_AddAddressTitle'] ";
	 ...
	 */
	public AddCustomerAddressDialog(final WebDriver driver) {
		super(driver);
	}
