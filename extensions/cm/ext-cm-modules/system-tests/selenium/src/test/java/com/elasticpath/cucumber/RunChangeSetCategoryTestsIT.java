...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/changesets/catalogManagement/category",
				"json:target/changesets/catalogManagement/category.json",
				"junit:target/cucumber-junit-reports/changesets/catalogManagement/category/cucumber.xml"},
