...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/catalogManagement/brand",
				"json:target/catalogManagement/brand.json",
				"junit:target/cucumber-junit-reports/catalogManagement/brand/cucumber.xml"},
