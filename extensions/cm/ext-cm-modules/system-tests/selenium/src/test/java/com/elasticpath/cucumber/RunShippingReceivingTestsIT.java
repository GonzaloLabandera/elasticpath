...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/shippingReceiving",
				"json:target/shippingReceiving.json",
				"junit:target/cucumber-junit-reports/shippingReceiving/cucumber.xml"},
