...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/dst",
				"json:target/catalogManagement/dst.json",
				"junit:target/cucumber-junit-reports/catalogManagement/dst/cucumber.xml"},
