...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/changesets/promotion",
				"json:target/changesets/promotion.json",
				"junit:target/cucumber-junit-reports/changesets/promotion/cucumber.xml"},
