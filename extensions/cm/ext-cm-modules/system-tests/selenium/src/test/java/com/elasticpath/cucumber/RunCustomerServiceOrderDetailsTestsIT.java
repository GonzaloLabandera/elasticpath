...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/customerService/order/orderDetails",
				"json:target/customerService/order/orderDetails.json",
				"junit:target/cucumber-junit-reports/customerService/order/orderDetails/cucumber.xml"},
