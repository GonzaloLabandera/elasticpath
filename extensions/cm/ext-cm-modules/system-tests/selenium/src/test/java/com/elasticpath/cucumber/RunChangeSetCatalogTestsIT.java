...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/changesets/catalogManagement/catalog",
				"json:target/changesets/catalogManagement/catalog.json",
				"junit:target/cucumber-junit-reports/changesets/catalogManagement/catalog/cucumber.xml"},
