...
@CucumberOptions(
		plugin = {"pretty", "html:target/cucumber-html-reports/configuration/paymentConfigurations",
				"json:target/configuration/paymentConfigurations.json",
				"junit:target/cucumber-junit-reports/configuration/paymentConfiguration/cucumber.xml"},
