@regressionTest @configuration @customerSegments
Feature: Customer Segments
  ...
  Scenario Outline: Create,Edit,Verify and Delete Customer Segment
    ...
    Then I should see the newly created customer segment
    When I search and open customer editor for shared ID <EMAIL_ID>
    ...
    Examples:
      | EMAIL_ID                           |
      | MOBEE:harry.potter@elasticpath.com |
  ...
  Scenario Outline: Item price depends on customer segment
    ...
    When I remove customer segment <CUSTOMER_SEGMENT> for the customer <SHARED_ID>
    ...
    Examples:
      | EMAIL_ID                     | CUSTOMER_SEGMENT | SEGMENT_ITEM_PRICE | SKU_CODE                                | STORE | SHARED_ID                          |
      | itestsegment@elasticpath.com | ITEST_SEGMENT    | $9999.00           | productUsedInCustomerSegmentsItests_sku | mobee | MOBEE:itestsegment@elasticpath.com |