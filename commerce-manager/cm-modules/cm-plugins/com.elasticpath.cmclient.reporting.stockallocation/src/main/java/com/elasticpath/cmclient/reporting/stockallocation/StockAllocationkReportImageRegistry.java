 ...
 */
public final class StockAllocationkReportImageRegistry {
	...
	private StockAllocationkReportImageRegistry() {
		// utility class
	}
	...
	private static URL getImageUrl(final String imageName) {
		return StockAllocationReportPlugin.getDefault().getBundle().getEntry("/icons/" + imageName); //$NON-NLS-1$
	}
}
