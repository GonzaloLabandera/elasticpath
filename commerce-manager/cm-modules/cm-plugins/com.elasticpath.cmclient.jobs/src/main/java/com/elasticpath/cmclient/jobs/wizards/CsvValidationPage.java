 ...
 * Csv validation page.
 */
public class CsvValidationPage extends AbstractImportJobValidationPage {

	/**
	 * A page name.
	 */
	public static final String PAGE_NAME = "CsvValidationPage"; //$NON-NLS-1$
	 ...
	 */
	public CsvValidationPage(final String title, final String description, final ImageDescriptor titleImage,
	...
	protected String getSubTitle() {
		return JobsMessages.get().RunWizard_CsvValidationPageErrorsSubTitle;
	}

	@Override
	protected String getErrorDescription() {
		return JobsMessages.get().RunWizard_CsvValidationPageErrors;
	}
