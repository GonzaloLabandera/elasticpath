 ...
 */
package com.elasticpath.cmclient.core.tablelableprovider;
 ...
 */
public abstract class AbstractTableLabelProviderDecorator implements ExtensibleTableLabelProvider {
	 ...
	 */
	public	AbstractTableLabelProviderDecorator(final ExtensibleTableLabelProvider decoratedTableLabelProvider) {
	 ...
	 */
	public String getBooleanMessage(final boolean onTrue) {
		String token;
		if (onTrue) {
	 ...
	 */
	public ExtensibleTableLabelProvider getDecoratedTableLabelProvider() {
