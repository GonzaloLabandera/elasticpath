...
public class ConditionBuilderFactoryImpl
	...
	private void initializeModel() {
		...
		this.tagOperatorService = (GenericService<TagOperator>) BeanLocator
				.getSingletonBean(ContextIdNames.TAG_OPERATOR_SERVICE, GenericService.class);
		TagDictionaryService tagDictionaryService = BeanLocator.getSingletonBean(ContextIdNames.TAG_DICTIONARY_SERVICE, TagDictionaryService.class);
		TagGroupService tagGroupService = BeanLocator.getSingletonBean(ContextIdNames.TAG_GROUP_SERVICE, TagGroupService.class);
