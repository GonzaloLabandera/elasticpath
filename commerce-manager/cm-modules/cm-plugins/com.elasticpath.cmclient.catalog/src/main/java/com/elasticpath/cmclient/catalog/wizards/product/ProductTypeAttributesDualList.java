 ...
 */
public class ProductTypeAttributesDualList extends AbstractAttributesDualList {
	 ...
	 */
	public ProductTypeAttributesDualList(final IPolicyTargetLayoutComposite parentComposite, final PolicyActionContainer container,
			final List<Attribute> model, final String availableTitle,
	...
	public List<Attribute> getAvailableAttributesList(
		...
		return attributeService.findByCatalogAndUsage(this.getCatalog().getUidPk(), AttributeUsage.PRODUCT);
	}
}
