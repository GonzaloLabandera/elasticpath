 ...
 */
public class ExcludeLinkedCategoryAuthorizationStatePolicy extends AbstractStatePolicyImpl {		
	...
	public class DefaultAuthorizationDeterminer implements StateDeterminer {
		...
		private boolean isCategoryValidForExclude() {
			return category.isLinked() && category.isIncluded() && category.hasParent();
		}
