...
/**
 * An action used to open the account details editor.
 */
public class OpenAccountDetailsEditorAction extends Action implements IDoubleClickListener {

	private static final Logger LOG = LogManager.getLogger(OpenAccountDetailsEditorAction.class);
	 ...
	 */
	public OpenAccountDetailsEditorAction(final TableViewer viewer, final IWorkbenchPartSite workbenchPartSite) {
		this.viewer = viewer;
	...
	public void run() {
		...
		if (obj instanceof Customer) {
			...
			try {
				this.workbenchPartSite.getPage().openEditor(editorInput, AccountDetailsEditor.ID_EDITOR);
